        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 max-h-[85vh] rounded-xl overflow-y-auto relative p-4">
            ...
            <div className="space-y-3">
              {[
                { size: "200gm",unit:"JAR",boxQu:"60", price: "Rs.90" },
                { size: "500gm",unit:"JAR",boxQu:"40", price: "Rs.150" },
                { size: "1kg",unit:"JAR",boxQu:"20", price: "Rs.290" },
              ].map((item, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div>
                      ...
                      <div className="text-xs text-gray-500">{item.unit} • {item.boxQu} per box</div>
                    </div>
                  </div>
